...
public class ConnectionContainerFromStateDropdown : DropdownScript, IStateHandler, IUpdateModelComponentNameHandler
{
    Model Model;
    ...
    public void InitializeComponent(MediatorComponent mediator, Model model, State fromState)
    {
        ...
        if (fromState != null)
        {
            int initialFromStateIndex = ModelComponentUniqueIDtoDropDownValue[fromState.UniqueID];
            SetValueWithoutNotify(initialFromStateIndex);
        }
